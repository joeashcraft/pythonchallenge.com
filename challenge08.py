...
base_url = 'http://www.pythonchallenge.com/pc/def/integrity.html'
...
# lcoords = [x for x in map(int,coords.split(','))]
# tcoords = []
# while lcoords:
#   _x = lcoords.pop(0)
#   _y = lcoords.pop(0)
#   tcoords.append((_x,_y))
## coordinates of map seem to NOT be part of the puzzle
